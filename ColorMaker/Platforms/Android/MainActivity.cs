...
[Activity(
    Theme = "@style/Maui.SplashTheme", MainLauncher = true, LaunchMode = LaunchMode.SingleTop, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation | ConfigChanges.UiMode | ConfigChanges.ScreenLayout | ConfigChanges.SmallestScreenSize | ConfigChanges.Density)]

//Splash Screen animado (https://dev.to/icebeam7/animated-splash-screen-in-net-maui-android-2ipg)
...
/*
    private void SetWindowLayout()
    {
        ...
        //Window.SetDecorFitsSystemWindows(false);
        //Window.SetFlags(WindowManagerFlags.Fullscreen, WindowManagerFlags.Fullscreen);
        //Window.SetStatusBarColor(Android.Graphics.Color.ParseColor("#F38C4D"));
